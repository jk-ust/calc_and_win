...
def run_game():
    ...
    enemy_health_after = enemy_health - user_total_attack
    if enemy_health_after < 0:
        print('Очки здоровья противника после твоей атаки: 0.')
    else:
        print(f'Очки здоровья противника'
              f'после твоей атаки: {enemy_health_after}.')
